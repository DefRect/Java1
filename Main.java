...
public class Main {
    ...
    private static void runningCheck() {
        ...
        for (int i = 0; i < COUNT_ANIMALS; i++) {
            if(animals[i].run(distance)){
                System.out.println(animals[i].getName() + " может пробежать " + distance + "м");
            } else{
                System.out.println(animals[i].getName() + " не может пробежать " + distance + "м");
            }
        }
    }
    ...
    private static void jumpCheck() {
        ...
        for (int i = 0; i < COUNT_ANIMALS; i++) {
            if(animals[i].jump(distance)){
                System.out.println(animals[i].getName() + " может прыгнуть на " + distance + "м");
            } else{
                System.out.println(animals[i].getName() + " не может прыгнуть на " + distance + "м");
            }
        }
    }
    ...
    private static void swimmingCheck() {
        ...
        for (int i = 0; i < COUNT_ANIMALS; i++) {
            if(animals[i].swim(distance)){
                System.out.println(animals[i].getName() + " может проплыть " + distance + "м");
            } else{
                System.out.println(animals[i].getName() + " не может проплыть " + distance + "м");
            }
        }
    }
}
